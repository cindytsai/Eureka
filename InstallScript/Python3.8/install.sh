...
cd Python-3.8.6
./configure --prefix=/work1/cindytsai/Software/python/python3.8 --enable-shared --enable-ipv6 LDFLAGS=-Wl,-rpath=/work1/cindytsai/Software/python/python3.8/lib,--disable-new-dtags
make
make install
